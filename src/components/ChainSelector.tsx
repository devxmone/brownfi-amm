...
import linea_Logo from "assets/svg/linea.svg";
...
const ChainSelector: FC = () => {
	...
	const items: MenuProps["items"] = useMemo(
		() => [
			...
			{ label: "Linea Mainnet", key: chainIds.linea, icon: labelToShow(linea_Logo, "Linea_Logo") },
			{ label: "Linea Testnet", key: chainIds.lineargoerli, icon: labelToShow(linea_Logo, "Linea_Logo") },
		],
		[]
	);
	...
	useEffect(() => {
		...
		if (chainId === 1 || chainId === 5) {
			...
			selectedLabel = labelToShow(linea_Logo, "linea_Logo");
		} else {
