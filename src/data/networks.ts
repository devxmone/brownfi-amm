...
export const CHAINS: {
	...
	324: {
		chainId: "324",
		urls: [alchemyKey ? `https://polygonzkevm-mainnet.g.alchemy.com/v2/${alchemyKey}` : "", "https://mainnet.era.zksync.io"].filter(Boolean),
	...
	280: {
		chainId: "280",
		urls: [alchemyKey ? `https://polygonzkevm-testnet.g.alchemy.com/v2/${alchemyKey}` : "", "https://testnet.era.zksync.dev"].filter(Boolean),
	...
	250: {
		chainId: "250",
		urls: [infuraKey ? `https://fantom-mainnet.gateway.pokt.network/v1/lb/${pocketNetwork}` : "", "https://rpc.ankr.com/fantom"].filter(Boolean),
	...
	97: {
		chainId: "97",
		urls: ["https://data-seed-prebsc-1-s1.binance.org:8545/", "https://data-seed-prebsc-1-s3.binance.org:8545/"].filter(Boolean),
	...
	59140: {
		chainId: "59140",
		urls: ["https://linea-goerli.blockpi.network/v1/rpc/public"].filter(Boolean),
		publicUrls: ["https://linea.build/"].filter(Boolean),
		name: "Linea Testnet",
		nativeCurrency: ETH,
	...
	59144: {
		chainId: "59144",
		urls: ["https://linea-mainnet.infura.io/v3/"].filter(Boolean),
		publicUrls: ["https://linea.build/"].filter(Boolean),
		name: "Linea Mainnet",
		nativeCurrency: ETH,
...
export const CHAINIDs: { [chainId: number]: string } = Object.keys(CHAINS).reduce<{ [chainId: number]: string }>((accumulator, chainId) => {
